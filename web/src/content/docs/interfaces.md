...
description: "Choose between the local web UI, CLI, TUI, and Audiobookshelf workflows."
---
...
See [Local Web UI](/audiobook-organizer/web-ui/).
...
See [Organize](/audiobook-organizer/organize/) and [CLI](/audiobook-organizer/cli/).
...
See [TUI](/audiobook-organizer/tui/).
