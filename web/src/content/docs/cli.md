---
title: "CLI"
description: "Use Audiobook Organizer from scripts and terminal commands."
---
...
**See also:** [INSTALLATION.md](/audiobook-organizer/installation/) for detailed platform-specific instructions
...
**See also:** [LAYOUTS.md](/audiobook-organizer/layouts/) for detailed layout comparison
...
**See also:** [METADATA.md](/audiobook-organizer/metadata/#field-mapping) for detailed field mapping guide
...
**See also:** [CONFIGURATION.md](/audiobook-organizer/configuration/) for complete configuration guide
...
**See also:** [METADATA.md](/audiobook-organizer/metadata/#flat-vs-non-flat) for detailed comparison
...
**See also:** [METADATA.md](/audiobook-organizer/metadata/) for metadata extraction guide
...
- See [METADATA.md](/audiobook-organizer/metadata/) for field mapping guide
...
- [GUI.md](/audiobook-organizer/web-ui/) - Local Web UI guide
- [TUI.md](/audiobook-organizer/tui/) - Terminal User Interface guide
- [METADATA.md](/audiobook-organizer/metadata/) - Metadata extraction guide
- [LAYOUTS.md](/audiobook-organizer/layouts/) - Directory layout options
- [CONFIGURATION.md](/audiobook-organizer/configuration/) - Configuration file format
- [INSTALLATION.md](/audiobook-organizer/installation/) - Platform-specific installation
