---
title: "Configuration"
description: "Configuration files, flags, and environment variables."
---
...
| Option | Type | Default | Description |
|--------|------|---------|-------------|
| `layout` | string | `author-series-title` | Directory structure pattern (see [LAYOUTS.md](/audiobook-organizer/layouts/)) |
...
- [CLI.md](/audiobook-organizer/cli/) - Command-line reference with all flags
- [METADATA.md](/audiobook-organizer/metadata/) - Field mapping deep dive
