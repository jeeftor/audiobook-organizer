...
<section class="media-callout">
  ...
  <div class="media-callout-copy">
    ...
    <p>Those <code>metadata.json</code> files are the safest first metadata source for local organization because they keep the book-level title, author, series, narrator, and year data beside the audio files.</p>
  </div>
</section>
